...
namespace Hl7.Cql.CqlToElm.Test
{
    ...
    {
        private static InvocationBuilder InvocationBuilder => CreateCqlToolkit().GetInvocationBuilder();
        ...
        {
            var lib = CreateCqlToolkit().MakeLibraryFromExpression("-9223372036854775808L");
        ...
        public void Boolean_Literal()
        {
            ...
            library = CreateCqlToolkit().MakeLibrary("""
        ...
        {
            var lib = CreateCqlToolkit().MakeLibraryFromExpression("@2016T");
        ...
        {
            var input = CreateCqlToolkit().MakeLibraryFromExpression("Ceiling(1.0)");
            var ceiling = input.Should().BeACorrectlyInitializedLibraryWithStatementOfType<Ceiling>();
            var output = CreateCqlToolkit().MakeLibraryFromExpression("1");
